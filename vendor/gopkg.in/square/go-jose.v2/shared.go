...
const (
	...
	Dilithium2AES                 = SignatureAlgorithm("Dilithium2-AES")
	Falcon512                     = SignatureAlgorithm("Falcon-512")
	RainbowIClassic               = SignatureAlgorithm("Rainbow-I-Classic")
	RainbowICircumzenithal        = SignatureAlgorithm("Rainbow-I-Circumzenithal")
	RainbowICompressed            = SignatureAlgorithm("Rainbow-I-Compressed")
	SphincsPlusHaraka128sSimple   = SignatureAlgorithm("SPHINCS+-Haraka-128s-Simple")
	SphincsPlusHaraka128fSimple   = SignatureAlgorithm("SPHINCS+-Haraka-128f-Simple")
	SphincsPlusHaraka128sRobust   = SignatureAlgorithm("SPHINCS+-Haraka-128s-Robust")
	SphincsPlusHaraka128fRobust   = SignatureAlgorithm("SPHINCS+-Haraka-128f-Robust")
	SphincsPlusSHA256128fSimple   = SignatureAlgorithm("SPHINCS+-SHA256-128s-Simple")
	SphincsPlusSHA256128sSimple   = SignatureAlgorithm("SPHINCS+-SHA256-128f-Simple")
	SphincsPlusSHA256128sRobust   = SignatureAlgorithm("SPHINCS+-SHA256-128s-Robust")
	SphincsPlusSHA256128fRobust   = SignatureAlgorithm("SPHINCS+-SHA256-128f-Robust")
	SphincsPlusSHAKE256128sSimple = SignatureAlgorithm("SPHINCS+-SHAKE256-128s-Simple")
	SphincsPlusSHAKE256128fSimple = SignatureAlgorithm("SPHINCS+-SHAKE256-128f-Simple")
	SphincsPlusSHAKE256128sRobust = SignatureAlgorithm("SPHINCS+-SHAKE256-128s-Robust")
	SphincsPlusSHAKE256128fRobust = SignatureAlgorithm("SPHINCS+-SHAKE256-128f-Robust")
)
